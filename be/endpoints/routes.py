...
async def get_routes(
    ...
    #             selectinload(LineDB.line_stations).selectinload(
    #                 LineStationDB.station)
    #         )
    #         .filter(LineDB.id == line_id)
    #         .first()
    #     )
    ...
    lines = (
        ...
        .options(
            selectinload(LineDB.routes),
            selectinload(LineDB.line_stations).selectinload(LineStationDB.station)
        )
